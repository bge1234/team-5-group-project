module.exports = {
  ...
  freebieProcess: function(freebies, dateType) {
    var dates = [];

    for (var i = 0; i < freebies.length; i++) {
      if(freebies[i][dateType] !== null) {
        date = new Date(freebies[i][dateType]);
